...
if (isset($_SESSION['AdminId']) && isset($_SESSION["AdminNom"]) && isset($_SESSION["AdminApel"]) && isset($_SESSION["AdminTel"]) && isset($_SESSION["AdminCorreo"]) && isset($_SESSION["AdminContra"]) && isset($_SESSION["Estado"])) {
    if (isset($_GET['accion'])) {
        ...
        if ($accion === 'logoutAdmin') {
            ...
            $controladorUsuario->consultarTablaUsuario($codigo, $pagina);
            ...
            $codigo = $_GET["codigo"];
            $pagina = isset($_GET["pagina"]) ? $_GET["pagina"] : 1;
            $controladorFuncionario->consultarTablaFuncionario($codigo,  $pagina);
            ...
            $codigo = $_GET["codigo"];
            $pagina = isset($_GET["pagina"]) ? $_GET["pagina"] : 1;
            $controladorCita->consultarTablaCita($codigo, $pagina);
        } elseif ($accion === 'registrocitas') {
            $FechaInicio = $_POST['FechaInicio'];
            $FechaFin = $_POST['FechaFin'];
            $controladorCita->registroCitas($FechaInicio, $FechaFin);
        } elseif ($accion === 'tablaadministrador') {
            require_once("Vista/html/tablaadministradores.php");
        }elseif ($accion === 'registraradmin'){
            $controladorAdministrador->registraradmin(
                $_REQUEST["AdminId"],
                $_REQUEST["AdminNom"],
                $_REQUEST["AdminApel"],
                $_REQUEST["AdminTel"],
                $_REQUEST["AdminCorreo"],
                $_REQUEST["AdminContra"],
                $_REQUEST["Estado"]
            );
        }elseif ($accion === 'consultartablaadmin') {
            $codigo = $_GET["codigo"];
            $pagina = isset($_GET["pagina"]) ? $_GET["pagina"] : 1;
            $controladorAdministrador->consultartablaadmin($codigo, $pagina);
        }elseif ($accion === 'cambiarEstadoCuentaAdmin') {
            $controladorAdministrador->cambiarEstadoCuentaAdmin($_GET['numero'], $_GET['nuevoEstado']);
        }elseif ($accion === 'actualizarPerfilAdmin') {
            $controladorAdministrador->actualizarPerfilAdmin(
                $_REQUEST["AdminId"],
                $_REQUEST["AdminNom"],
                $_REQUEST["AdminApel"],
                $_REQUEST["AdminTel"],
    ...
    if (isset($_GET['accion'])) {
        ...
        } elseif ($accion === 'consultartablacitausu') {
            $codigo = $_GET["codigo"];
            $pagina = isset($_GET["pagina"]) ? $_GET["pagina"] : 1;
            $controladorCita->consultarTablaCitaUsu($codigo, $pagina);
    ...
    if (isset($_GET['accion'])) {
        ...
        } elseif ($accion === 'consultartablacitafun') {
            $codigo = $_GET["codigo"];
            $pagina = isset($_GET["pagina"]) ? $_GET["pagina"] : 1;
            $controladorCita->consultarTablaCitaFun($codigo, $pagina);
    ...
    if (isset($_GET['accion'])) {
        ...
        if (in_array($accion, $acciones_publicas)) {
            ...
            switch ($accion) {
                case 'inicio':
                    $controladorUsuario->agregaTipoUsuario();
                ...
                case 'registrarusuarios':
                    $controladorUsuario->registrarusuarios(
                        $_REQUEST["UsuId"],
                        $_REQUEST["UsuNombre"],
                        $_REQUEST["UsuApellido"],
                        $_REQUEST["UsuCorreo"],
