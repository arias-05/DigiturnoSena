...
class ControladorFuncionario
{
    ...
    public function consultarTablaFuncionario($codigo, $pagina = 1, $porPagina = 3)
    {
        $gestorFuncionario = new GestorFuncionario();
        $totalFuncionarios = $gestorFuncionario->contarFuncionarios($codigo);
        $result = $gestorFuncionario->consultarTablaFuncionarios($codigo, $pagina, $porPagina);
