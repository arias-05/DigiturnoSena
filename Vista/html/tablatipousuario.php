            ...
            <div class="col-xxl-12">
                <div class='card-header'>
                    ...
                    <div class='card-body'>
                        ...
                        <div class='card-body'>
                            <button type="button" class="custom-icon-button edit-button" data-bs-toggle="modal" data-bs-target="#ingresarusuario">
                                Agregar Nuevo Tipo Usuario
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="ingresarusuario" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="index.php?accion=insertarTipoUsu" method="POST">
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="TuDetalle" class="form-label">Ingrese el tipo de usuario</label>
                                                    <input type="text" class="form-control" id="TuDetalle" name="TuDetalle">
                                                </div>
                                            </div>
                            ...
                            <div class="input-group mt-3 mb-4">
                                ...
                                <button class="custom-icon-button edit-button" onclick="Mostrartipousu()">Buscar</button>
                            </div>
