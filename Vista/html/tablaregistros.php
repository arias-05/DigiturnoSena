...
<head>
    ...
    <title>Usuario Registrados</title>
    <!-- Bootstrap CSS -->
                ...
                <div class='card-header'>
                    ...
                    <div class='card-body'>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <?php endif; ?>
                                        <form action="index.php?accion=registrarusuario" method="POST" id="registroForm">
                        ...
                        <div class="input-group mt-3">
                            <input type="text" class="form-control col-sm-2" name="filtro" id="filtro" placeholder="Buscar Usuario Registrado">
                            <button class="custom-icon-button bi bi-search " onclick="Mostrarregistro()"> Buscar</button>
                        </div>
