            ...
            <div class="col-xxl-12">
                <div class='card-header'>
                    ...
                    <div class='card-body'>
                        ...
                        <button type="button" class="custom-icon-button edit-button" data-bs-toggle="modal" data-bs-target="#ingresarfuncionario">
                            Nuevo tipo funcionario
                        </button>

                        <!-- Modal -->
                        <div class="modal fade" id="ingresarfuncionario" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="index.php?accion=insertarTipofuncio" method="POST">
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                <label for="TuDetalle" class="form-label">Ingrese el tipo funcionario</label>
                                                <input type="text" class="form-control" id="TipoFncionario" name="TipoFncionario">
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="custom-icon-button edit-button" data-bs-dismiss="modal">Cerrar</button>
                                            <button type="submit" class="custom-icon-button edit-button">Guardar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="input-group mt-3">
                            <input type="text" class="form-control col-sm-2" name="filtro" id="filtro" placeholder="Buscar Tipo de Usuario">
                            <button class="custom-icon-button bi bi-search " onclick="Mostrartipofuncio()">Buscar</button>
                        </div>
                        <div id="tipofuncionario"></div>
                        <script>
                            Mostrartipofuncio();
                        </script>
                    </div>
