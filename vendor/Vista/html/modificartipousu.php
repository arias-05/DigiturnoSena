            ...
            <div class="col-xxl-12">
                <div class='card-header'>
                    <div class="d-flex justify-content-between">
                        ...
                        <h1>Editar tipo Usuario (<?php echo $filas['TuDetalle']; ?>)</h1>                        </div>
                    ...
                    <div class='card-body mb-3'>
                        ...
                        <button type="button" class="custom-icon-button edit-button" data-bs-toggle="modal" data-bs-target="#actualizartipousu">
                            Actualizar Tipo Usuario
                        </button>

                        <!-- Modal -->
                        <div class="modal fade" id="actualizartipousu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form id="actualizartipousuario" novalidate method="post" action="index.php?accion=actualizartipousu">
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                <label for="TuId" class="form-label">Id tipo de Usuario</label>
                                                <input type="text" class="form-control" id="TuId" name="TuId" required value="<?php echo $filas['TuId']; ?> *No modificable*" readonly style="color: gray;">
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label">Nuevo nombre tipo usuario</label>
                                                <input type="text" class="form-control" id="TuDetalle" name="TuDetalle" required value="<?php echo $filas['TuDetalle']; ?>">
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="custom-icon-button edit-button" data-bs-dismiss="modal">Cerrar</button>
                                            <button type="submit" class="custom-icon-button edit-button" onclick="alert('Se actualizo correctamente el tipo usuario <?php echo $filas['TuDetalle']; ?> ');">Actualizar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        </div>
                        <a href="index.php?accion=tablatipousuario" class="custom-icon-button edit-button">Cancelar edición</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-striped table-hover align-middle text-center table-bordered" id="tablatipousu">
                            ...
                            <tbody>
                                <tr>
                                    <td><?php echo $filas['TuId']; ?></td>
                                    <td><?php echo $filas['TuDetalle']; ?></td>
                                    </tr>
                            </tbody>
                        </table>
                    </div>
