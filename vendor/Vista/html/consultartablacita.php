                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php echo $fila->Estado; ?></td>
                                <td>
                                    <button type="button" class="custom-icon-button edit-button" data-bs-toggle="modal" data-bs-target="#cancelarCita_<?php echo $fila->TurnoId; ?>" <?php echo startsWith($fila->Estado, 'Cancelado:') ? 'disabled' : ''; ?>>
                                        Cancelar
                                    </button>
                                    <br><br>
                                    <button type="button" class="custom-icon-button edit-button" data-bs-toggle="modal" data-bs-target="#editarCita_<?php echo $fila->TurnoId; ?>" <?php echo (startsWith($fila->Estado, 'Cancelado:') || $fila->Estado === 'Asignada') ? 'disabled' : ''; ?>>
                                        Editar
                                    </button>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else : ?>
                                        ...
                                        <button type="button" class="custom-icon-button edit-button" data-bs-toggle="modal" data-bs-target="#agendarCita_<?php echo $fila->TurnoId; ?>">
                                            Agendar
                                        </button>
                                    <?php endif; ?>
                                    <br><br>
