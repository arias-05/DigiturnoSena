...
<head>
    ...
    <title>Funcionario Registrados</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="col-xxl-12">
                <div class='card-header'>
                    ...
                    <div class='card-body mb-3'>
                        <button type="button" class="custom-icon-button edit-button mb-3" data-bs-toggle="modal" data-bs-target="#RegistrarFuncionario">
                            Registrar Nuevo Funcionarios
                        </button>

                        <!-- Modal -->
                        <div class="modal fade" id="RegistrarFuncionario" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Ingrese el nuevo Funcionario</h5>
                                    ...
                                    <?php if (isset($_GET['alert_message'])) : ?>
                                        ...
                                        <?php endif; ?>
                                        <form action="index.php?accion=RegistrarFuncionario" method="POST" id="registroForm">
                                            <div class="form-group">
                                                <label for="FunId">Documento de identidad:</label>
                                                <input type="text" id="FunId" name="FunId" class="form-control" required>
                                                <span></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="FunNombre">Nombre:</label>
                                                <input type="text" id="FunNombre" name="FunNombre" class="form-control" required>
                                                <span></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="FunApellido">Apellido:</label>
                                                <input type="text" id="FunApellido" name="FunApellido" class="form-control" required>
                                                <span></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="FunTelefono">Número de teléfono:</label>
                                                <input type="number" id="FunTelefono" name="FunTelefono" class="form-control" required>
                                                <span></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="FunCorreo">Correo electrónico:</label>
                                                <input type="email" id="FunCorreo" name="FunCorreo" class="form-control" required>
                                                <span></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="FunContraseña">Contraseña:</label>
                                                <input type="password" id="FunContrasena" name="FunContrasena" class="form-control" required>
                                                <span></span>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="TipoFunId" name="TipoFunId" required>
                                                    <option selected disabled value="">Elige el tipo de funcionario</option>

                                                    <?php
                                                    while ($fila = $result->fetch(PDO::FETCH_OBJ)) {
                                                    ?>
                                                        <option value="<?php echo $fila->TipoFunId; ?>"><?php echo $fila->TipoFncionario; ?></option>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="custom-icon-button edit-button" data-dismiss="modal">Volver</button>
                                                <button type="submit" class="custom-icon-button edit-button">Registrarse</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control col-sm-2" name="filtro" id="filtro" placeholder="Buscar por Tipo de Usuario">
                            <button class="custom-icon-button bi bi-search " onclick="Mostrarfuncionarios()">Buscar</button>
                        </div>
