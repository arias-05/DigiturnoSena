            ...
            <div class="col-xxl-12">
                <div class='card-header'>
                    ...
                    <div class='card-body mb-3'>
                        <button type="button" class="custom-icon-button edit-button mb-3" data-bs-toggle="modal" data-bs-target="#RegistrarFuncionarios">
                            Registrar Nuevo Funcionarios
                        </button>

                        <!-- Modal -->
                        <div class="modal fade" id="RegistrarFuncionarios" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="index.php?accion=registrarfuncionarios" method="POST" id="registroForm">
